...
const DeiGeneralInfo = () => {
  ...
  const handleInsuranceInputModeChange = (value) => {
    setFormData((prev) => {
      ...
      if (value === 'yearsMonths' && (!prev.totalInsuranceYears && !prev.totalInsuranceMonths) && prev.totalInsuranceDays) {
        const convertedInsuranceTime = convertDaysToYearsMonths(prev.totalInsuranceDays);
        nextState.totalInsuranceYears = convertedInsuranceTime.years ? String(convertedInsuranceTime.years) : '';
        nextState.totalInsuranceMonths = convertedInsuranceTime.months ? String(convertedInsuranceTime.months) : '';
      }
  ...
  const handleNextStep = () => {
    ...
    const totalDeclaredMonths = outsideBefore2014TotalMonths;
    ...
    <div className="info-wrapper">
      ...
      <div className="info-top-actions">
        <div className="info-top-actions-note">
          Συμπληρώστε τα πεδία με τον τρόπο που τα γνωρίζετε ήδη από το ιστορικό σας.
        </div>
      ...
      <div className="info-form-panel info-main-panel">
        <div className="info-sections-stack">
          ...
          <div className="info-card info-card-green">
            <div className="info-card-header">
              <div>
                <h3 className="info-card-title">Κατηγορία ενσήμων</h3>
                <p className="info-card-text">Εδώ δηλώνεται η κατηγορία με την οποία θεμελιώνεται το δικαίωμα.</p>
              </div>
            </div>
