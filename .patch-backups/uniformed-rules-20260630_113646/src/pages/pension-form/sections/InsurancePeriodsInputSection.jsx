...
function UniformedSpecialTimeFields({
  ...
  const supportsArticle36A =
    uniformedBodySupportsArticle36A(uniformedBody);
  const safeValue = {
    ...normalizedValue,
    insuranceRegime:
  ...
  const article36ACategory =
    safeValue.article36ACategory;
  const insuranceRegimeLabel =
    getUniformedInsuranceRegimeLabel(
      insuranceRegime
    );
  const article36AOptions =
    getArticle36ACategoryOptions(
      uniformedBody
    );
  const combatStatus =
  ...
  return (
    <div style={uniformedBoxStyle}>
      ...
      <p style={{ color: '#475569' }}>
        Στη δωρεάν έκδοση η μάχιμη πενταετία και τα
        εξάμηνα υπολογίζονται με τον ίδιο βασικό
        μηχανισμό που χρησιμοποιείται για πλασματικό
        χρόνο με εξαγορά. Αν δηλωθούν αναλυτικές
        ετήσιες αποδοχές, χρησιμοποιούνται οι αποδοχές
        των αντίστοιχων ετών. Αν δηλωθεί έτοιμος μέσος
        μηνιαίος μισθός, χρησιμοποιείται αυτός ως βάση.
      </p>
      ...
      <div style={gridStyle}>
        ...
        {supportsArticle36A && (
          <SelectWithLabel
            ...
            onChange={(fieldValue) =>
              updateUniformedField(
                'article36ACategory',
                fieldValue
              )
            }
            options={article36AOptions}
          />
        )}
      </div>
      ...
      {supportsArticle36A && (
        ...
        >
          Το άρθρο 36Α δηλώνεται μόνο όταν υπάρχει πραγματική υπαγωγή
          σε μία από τις ειδικές κατηγορίες που εμφανίζονται για το
          επιλεγμένο σώμα.
        </p>
      )}
            ...
            <>
              ...
              {safeValue
                ...
                <TextInputWithLabel
                  ...
                  label="Έτος μεταγενέστερης αναγνώρισης / εξαγοράς"
                  value={
                    safeValue
                      .combatFiveYearService
                      .applicationYear
          ...
          {hasSpecialSemesters && (
            <>
              ...
              <SelectWithLabel
                ...
                options={
                  SPECIAL_SEMESTERS_TYPE_OPTIONS
                }
                required
              />
...
function getUniformedSpecialTimeValidationError(
  ...
  if (
    ...
    return 'Η επιλεγμένη κατηγορία άρθρου 36Α δεν αντιστοιχεί στο συγκεκριμένο σώμα.';
  }
...
const UNIFORMED_CONTRIBUTION_PAYMENT_MODE_OPTIONS = [
  ...
  },
  {
    ...
    label: 'Έγινε μεταγενέστερη αναγνώριση / εξαγορά',
  },
  {
